            ...
            <div className="bg-gray-800">
                ...
                <main className="p-4 space-y-6">
                    <div className="text-right">
                        <h3 className="font-bold text-gray-200">اختر مبلغ الشحن</h3>
                    </div>
                    ...
                    <div>
                        <h3 className="font-bold text-right mb-2 text-gray-200">أو أدخل مبلغًا مخصصًا</h3>
                        <div className="relative">
                             <input 
                                ...
                                className="w-full p-4 rounded-lg border-gray-600 bg-gray-700 text-white border focus:ring-indigo-500 focus:border-indigo-500 text-right pr-12 placeholder-gray-400"
                            />
                             <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400">EGP</span>
                        </div>
                    </div>

                     <button onClick={handleRecharge} className="w-full bg-indigo-500 text-white font-bold p-3 rounded-lg shadow-lg !mt-8">
                        اشحن الآن
                    </button>

                    <div className="text-right text-sm text-gray-400 space-y-2">
                        <h3 className="font-bold text-base text-gray-200">تعليمات إعادة الشحن</h3>
